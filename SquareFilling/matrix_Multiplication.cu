...
int main(void)
{
    ...
    fp=fopen("Matrix_Multiplication.csv","w+");
    fprintf(fp,"Block_Size(m=n),Matrix_1(m=n),Matrix_2(m=n),CPU_Time,GPU_Time");
    ...
    fprintf(fp,"\n%d,%d,%d,%f,%lf",BLOCK_SIZE,Left_matrix_x,Right_matrix_x,et,time_spent);
