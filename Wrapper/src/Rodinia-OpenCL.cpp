...
int main(int argc, char* argv[])
{
	...
	const string base_dir = "/home/suejb/benchmarks/Rodinia/rodinia_3.1/opencl/";
	const string file_name = "rodinia_opencl_ida";
	const string file_size = "ref";
	const string tune = "base";

	// const string applications[] = {"b+tree", "backprop", "bfs", "cfd", "heartwall", "hotspot", "hotspot3D", "kmeans", "lavaMD", "lud/ocl", "myocyte", "nw", "particlefilter", "srad", "streamcluster"};
	const string applications[] = {"myocyte", "nw", "particlefilter", "srad", "streamcluster"};
